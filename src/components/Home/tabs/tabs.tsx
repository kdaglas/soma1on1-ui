      ...
      return (
        <div className="tablets">
          <div className="content">
            ...
            <p>
              Soma1on1 literary means learn one on one with a professional tutor of your choice.
              <br />
              Whether you are a learner or parent, now you can have access to a wider variety
              <br />
              of subject and their tutors more easily than ever before.
            </p>
          </div>
